...
CELL_TYPES = {
    ...
    # 보류 사유는 두 가지인데 실측(2026-08-26)으로는 98.3%가 표본부족이다
    # (1,571셀 중 표본부족 1,545 / 누적 미산출 26). 예전 문구는 소수 쪽만 말하고 있었다.
    "유형판정보류": {
        "summary": "유형을 판정할 자료가 부족합니다.",
        "advice": "점포 수가 기준에 못 미쳐 유형을 나누지 않았습니다. "
                  "개업·폐업률이 있더라도 표본이 작아 분류가 노이즈에 흔들립니다. "
                  "현장 확인을 권장합니다.",
        "avoid": "",
    },
}
